...
class TagDetector {
    public:
        ...
        */
        static Step_1 createOriginalImage(const cv::Mat& image);
        ...
        */
        static Step_2 optionallyApplyLowPassFilter(Step_1 step1, float sigma);
        ...
        */
        static Step_3 applyLowPassFilterAndGrayScale(Step_1 step1, Step_2 step2, float sigma, float segSigma);
        ...
        */
        static Step_5 extractEdges(Step_3 step3, Step_4 step4, int width, int height);
        ...
        */
        static Step_6 createClusters(Step_3 step3, Step_4 step4, Step_5 step5);
        ...
        */
        static Step_7 fitSegments(Step_4 step4, Step_6 step6);
        ...
        */
        static Step_8 connectSegments(Step_7* step7, int width, int height);
        ...
        */
        static Step_9 createQuads(Step_1 step1, Step_7* step7);
        ...
        */
        static Step_10 decodeQuads(Step_2 step2, Step_9 step9, int width, int height, AprilTag::TagFamily tagFamily);
        ...
        */
        static Step_11 removeDuplicates(Step_10 step10);

        virtual std::vector<AprilTag::TagDetection> extractTags(const cv::Mat& image, AprilTag::TagFamily tagFamily, DemoControls* controls) = 0;
};
