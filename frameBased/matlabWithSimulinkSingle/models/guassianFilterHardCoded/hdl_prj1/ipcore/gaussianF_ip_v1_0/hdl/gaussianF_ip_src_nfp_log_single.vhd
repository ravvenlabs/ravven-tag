-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_src_nfp_log_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_src_nfp_log_single
-- Source Path: gaussianFilter/gaussianFilter/singleToUint32/nfp_log_single
-- Hierarchy Level: 2
-- Model version: 8.39
-- 
...
ENTITY gaussianF_ip_src_nfp_log_single IS
...
END gaussianF_ip_src_nfp_log_single;


ARCHITECTURE rtl OF gaussianF_ip_src_nfp_log_single IS
  ...
  SIGNAL Delay1_PS_2_out1                 : unsigned(22 DOWNTO 0);  -- ufix23
  ...
  SIGNAL Switch_out1_5                    : signed(49 DOWNTO 0);  -- sfix50_En47
  ...
  SIGNAL constant1_out1_12                : unsigned(24 DOWNTO 0);  -- ufix25
  ...
  SIGNAL Add_out1_2                       : unsigned(7 DOWNTO 0);  -- ufix8
...
BEGIN
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay1_PS_1_out1 = to_unsigned(16#00#, 8) ELSE
      '0';
  ...
  Delay1_PS_2_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay1_PS_2_out1 <= to_unsigned(16#000000#, 23);
      ELSIF enb = '1' THEN
        Delay1_PS_2_out1 <= BitSlice_out1;
      END IF;
    END IF;
  ...
  bitsliceget_mant_norm_mant_no_out1 <= '1' WHEN Delay1_PS_2_out1 /= to_unsigned(16#000000#, 23) ELSE
      '0';
  ...
  Bit_Concat_out1_1 <= Constant_out1_1 & Delay1_PS_2_out1 & Constant1_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay2_PS_2_out1 <= if_Exponent_0_out1;
      END IF;
    END IF;
  END PROCESS Delay2_PS_2_process;


  DTC_out1_1 <= signed(resize(Delay2_PS_2_out1, 11));
  ...
  Bit_Concat_out1_2 <= unsigned(Delay2_PS_19_20_out1) & Constant_out1_2;
  ...
  Switch1_out1 <= Data_Type_Conversion_out1 WHEN Delay1_PS_19_20_out1 = '0' ELSE
      Constant1_out1_2;

  Constant2_out1 <= signed'("0000000000010110001011100100001011111110111110100011100111");

  
  Switch_out1_1 <= Switch1_out1 WHEN Delay_PS_19_20_out1 = '0' ELSE
      Constant2_out1;
  ...
  Logical_Operator2_out1_1 <= w_hat_0_5_out1 OR w_hat_0_75_out1;

  bitsll_w_1_out1_1 <= Delay8_PS_4_out1 sll 1;

  BitSlice1_out1 <= Delay8_PS_4_out1(29);

  Logical_Operator_out1_2 <=  NOT BitSlice1_out1;

  Constant_out1_3 <= to_unsigned(16#2000000#, 26);

  Bit_Concat_out1_3 <= Logical_Operator_out1_2 & Logical_Operator_out1_2 & Logical_Operator_out1_2 & Constant_out1_3 & Logical_Operator_out1_2;

  DTC_out1_2 <= signed(Bit_Concat_out1_3);

  Bit_Concat_out1_4 <= unsigned'(Logical_Operator_out1_2 & Logical_Operator_out1_2);
  ...
  if_w_hat_0_75_1_out1 <= bitsll_w_1_out1_1 WHEN Logical_Operator2_out1_1 = '0' ELSE
      alpha2_tmp1_out1;
  ...
  Logical_Operator2_out1_2 <= w_hat_0_5_out1_1 OR w_hat_0_75_out1_1;

  bitsll_w_1_out1_2 <= if_w_hat_0_75_1_out1 sll 1;

  BitSlice1_out1_1 <= if_w_hat_0_75_1_out1(29);

  Logical_Operator_out1_3 <=  NOT BitSlice1_out1_1;

  Constant_out1_4 <= to_unsigned(16#2000000#, 26);

  Bit_Concat_out1_5 <= Logical_Operator_out1_3 & Logical_Operator_out1_3 & Logical_Operator_out1_3 & Constant_out1_4 & Logical_Operator_out1_3;

  DTC_out1_3 <= signed(Bit_Concat_out1_5);

  Bit_Concat_out1_6 <= unsigned'(Logical_Operator_out1_3 & Logical_Operator_out1_3);
  ...
  if_w_hat_0_75_1_out1_1 <= bitsll_w_1_out1_2 WHEN Logical_Operator2_out1_2 = '0' ELSE
      alpha2_tmp1_out1_1;
  ...
  BitSlice1_out1_2 <= Delay1_PS_6_out1(29);

  Logical_Operator_out1_4 <=  NOT BitSlice1_out1_2;

  Constant1_out1_3 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_3 <= Logical_Operator_out1_4 & Logical_Operator_out1_4 & Logical_Operator_out1_4 & Constant1_out1_3 & Logical_Operator_out1_4;

  DTC_out1_4 <= signed(Bit_Concat1_out1_3);

  Bit_Concat_out1_7 <= unsigned'(Logical_Operator_out1_4 & Logical_Operator_out1_4);
  ...
  BitSlice1_out1_3 <= Delay9_PS_7_out1(29);

  Logical_Operator_out1_5 <=  NOT BitSlice1_out1_3;

  Constant1_out1_4 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_5 <= Logical_Operator_out1_5 & Logical_Operator_out1_5 & Logical_Operator_out1_5 & Constant1_out1_4 & Logical_Operator_out1_5;

  DTC_out1_5 <= signed(Bit_Concat1_out1_5);

  Bit_Concat_out1_8 <= unsigned'(Logical_Operator_out1_5 & Logical_Operator_out1_5);
  ...
  BitSlice1_out1_4 <= Delay3_PS_8_out1(29);

  Logical_Operator_out1_6 <=  NOT BitSlice1_out1_4;

  Constant1_out1_5 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_7 <= Logical_Operator_out1_6 & Logical_Operator_out1_6 & Logical_Operator_out1_6 & Constant1_out1_5 & Logical_Operator_out1_6;

  DTC_out1_6 <= signed(Bit_Concat1_out1_7);

  Bit_Concat_out1_9 <= unsigned'(Logical_Operator_out1_6 & Logical_Operator_out1_6);
  ...
  Logical_Operator_out1_7 <=  NOT BitSlice1_out1_5;

  Constant1_out1_6 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_9 <= Logical_Operator_out1_7 & Logical_Operator_out1_7 & Logical_Operator_out1_7 & Constant1_out1_6 & Logical_Operator_out1_7;

  DTC_out1_7 <= signed(Bit_Concat1_out1_9);

  Bit_Concat_out1_10 <= unsigned'(Logical_Operator_out1_7 & Logical_Operator_out1_7);
  ...
  BitSlice1_out1_6 <= Delay5_PS_10_out1(29);

  Logical_Operator_out1_8 <=  NOT BitSlice1_out1_6;

  Constant1_out1_7 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_11 <= Logical_Operator_out1_8 & Logical_Operator_out1_8 & Logical_Operator_out1_8 & Constant1_out1_7 & Logical_Operator_out1_8;

  DTC_out1_8 <= signed(Bit_Concat1_out1_11);

  Bit_Concat_out1_11 <= unsigned'(Logical_Operator_out1_8 & Logical_Operator_out1_8);
  ...
  Logical_Operator_out1_9 <=  NOT BitSlice1_out1_7;

  Constant1_out1_8 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_13 <= Logical_Operator_out1_9 & Logical_Operator_out1_9 & Logical_Operator_out1_9 & Constant1_out1_8 & Logical_Operator_out1_9;

  DTC_out1_9 <= signed(Bit_Concat1_out1_13);

  Bit_Concat_out1_12 <= unsigned'(Logical_Operator_out1_9 & Logical_Operator_out1_9);
  ...
  BitSlice1_out1_8 <= Delay7_PS_12_out1(29);

  Logical_Operator_out1_10 <=  NOT BitSlice1_out1_8;

  Constant1_out1_9 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_15 <= Logical_Operator_out1_10 & Logical_Operator_out1_10 & Logical_Operator_out1_10 & Constant1_out1_9 & Logical_Operator_out1_10;

  DTC_out1_10 <= signed(Bit_Concat1_out1_15);

  Bit_Concat_out1_13 <= unsigned'(Logical_Operator_out1_10 & Logical_Operator_out1_10);
  ...
  Logical_Operator_out1_11 <=  NOT BitSlice1_out1_9;

  Constant1_out1_10 <= to_unsigned(16#2000000#, 26);

  Bit_Concat1_out1_17 <= Logical_Operator_out1_11 & Logical_Operator_out1_11 & Logical_Operator_out1_11 & Constant1_out1_10 & Logical_Operator_out1_11;

  DTC_out1_11 <= signed(Bit_Concat1_out1_17);

  Bit_Concat_out1_14 <= unsigned'(Logical_Operator_out1_11 & Logical_Operator_out1_11);
  ...
  Logical_Operator_out1_12 <= Bit_Slice3_out1 OR Bit_Slice6_out1;

  Logical_Operator1_out1_8 <= Bit_Slice5_out1 OR Logical_Operator_out1_12;
  ...
  Logical_Operator_out1_13 <= Bit_Slice5_out1_1 OR Bit_Slice3_out1_1;

  Logical_Operator1_out1_9 <= Logical_Operator3_out1 OR Logical_Operator_out1_13;
  ...
  Logical_Operator2_out1_3 <= Bit_Slice_out1_1 OR Bit_Slice4_out1;

  Logical_Operator5_out1 <= Logical_Operator4_out1 OR Logical_Operator2_out1_3;
  ...
  Logical_Operator_out1_14 <= Bit_Slice5_out1_2 OR Bit_Slice3_out1_2;

  Logical_Operator1_out1_10 <= Logical_Operator3_out1_1 OR Logical_Operator_out1_14;
  ...
  Logical_Operator2_out1_4 <= Bit_Slice_out1_2 OR Bit_Slice4_out1_1;

  Logical_Operator5_out1_1 <= Logical_Operator4_out1_1 OR Logical_Operator2_out1_4;
  ...
  Logical_Operator_out1_15 <= Bit_Slice5_out1_3 OR Bit_Slice3_out1_3;
  ...
  Logical_Operator1_out1_11 <= Logical_Operator3_out1_2 OR Logical_Operator_out1_15;
  ...
  Logical_Operator2_out1_5 <= Logical_Operator1_out1_8 OR Logical_Operator6_out1;
  ...
  Switch34_out1 <= Switch33_out1 WHEN Logical_Operator2_out1_5 = '0' ELSE
      Switch2_out1_3;
  ...
  DTC_out1_12 <= signed(resize(Delay14_PS_17_18_out1(51 DOWNTO 3), 50));
  ...
  Switch_out1_5 <= DTC_out1_12 WHEN Delay16_PS_17_18_out1 = '0' ELSE
      alphaw1_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay8_PS_19_20_reg(0) <= Switch_out1_5;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay21_PS_22_out1 <= Switch_out1_1;
      END IF;
    END IF;
  ...
  Switch_out1_6 <= Delay13_PS_26_out1 WHEN Delay9_PS_2_26_out1 = '0' ELSE
      Delay6_PS_2_26_out1;

  
  Switch1_out1_5 <= Constant1_out1 WHEN Relational_Operator_out1 = '0' ELSE
      Switch_out1_6;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay3_PS_27_out1 <= '0';
      ELSIF enb = '1' THEN
        Delay3_PS_27_out1 <= Switch1_out1_5;
      END IF;
    END IF;
  ...
  Switch_out1_7 <= Delay12_PS_23_out1 WHEN BitSlice_out1_13 = '0' ELSE
      Unary_Minus_out1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay1_PS_24_out1 <= Switch_out1_7;
      END IF;
    END IF;
  END PROCESS Delay1_PS_24_process;


  BitSlice1_out1_11 <= unsigned(Delay1_PS_24_out1(56 DOWNTO 0));
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_PS_25_out1 <= BitSlice1_out1_11;
      END IF;
    END IF;
  ...
  Logical_Operator1_out1_12 <= Logical_Operator3_out1_4 OR Logical_Operator_out1_16;
  ...
  Logical_Operator1_out1_13 <= Logical_Operator3_out1_5 OR Logical_Operator_out1_17;
  ...
  Logical_Operator5_out1_3 <= Logical_Operator4_out1_5 OR Logical_Operator2_out1_7;
  ...
  Logical_Operator_out1_18 <= Bit_Slice5_out1_7 OR Bit_Slice3_out1_6;

  Logical_Operator1_out1_14 <= Logical_Operator3_out1_6 OR Logical_Operator_out1_18;
  ...
  Logical_Operator2_out1_8 <= Bit_Slice_out1_6 OR Bit_Slice4_out1_5;

  Logical_Operator5_out1_4 <= Logical_Operator4_out1_6 OR Logical_Operator2_out1_8;
  ...
  Logical_Operator_out1_19 <= Bit_Slice5_out1_8 OR Bit_Slice3_out1_8;

  Logical_Operator1_out1_16 <= Logical_Operator3_out1_7 OR Logical_Operator_out1_19;
  ...
  Logical_Operator5_out1_5 <= Logical_Operator4_out1_7 OR Logical_Operator2_out1_9;
  ...
  Logical_Operator_out1_20 <= Bit_Slice5_out1_9 OR Bit_Slice3_out1_9;

  Logical_Operator1_out1_17 <= Logical_Operator3_out1_8 OR Logical_Operator_out1_20;
  ...
  Logical_Operator5_out1_6 <= Logical_Operator4_out1_8 OR Logical_Operator2_out1_10;
  ...
  Logical_Operator_out1_21 <= Bit_Slice5_out1_10 OR Bit_Slice3_out1_10;

  Logical_Operator1_out1_18 <= Logical_Operator3_out1_9 OR Logical_Operator_out1_21;
  ...
  Logical_Operator5_out1_7 <= Logical_Operator4_out1_9 OR Logical_Operator2_out1_11;
  ...
  Logical_Operator2_out1_12 <= Logical_Operator6_out1_5 OR Logical_Operator6_out1_6;
  ...
  Switch34_out1_1 <= Switch33_out1_1 WHEN Logical_Operator2_out1_12 = '0' ELSE
      Switch2_out1_8;
  ...
  LogicalOperator1_out1 <= BitSlice1_out1_12 OR Delay1_PS_26_out1;

  LogicalOperator_out1 <= BitSlice_out1_14 AND LogicalOperator1_out1;

  constant1_out1_12 <= to_unsigned(16#0000002#, 25);

  Add1_out1 <= Bit_Concat_out1_23 + constant1_out1_12;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay17_PS_26_out1 <= Switch1_out1_14;
      END IF;
    END IF;
  ...
  Add_out1_2 <= Delay17_PS_26_out1 + constant_out1_12;

  
  switch_out1_15 <= Delay17_PS_26_out1 WHEN BitSlice2_out1_2 = '0' ELSE
      Add_out1_2;
  ...
  Switch2_out1_12 <= switch_out1_15 WHEN Delay9_PS_2_26_out1 = '0' ELSE
      Delay7_PS_2_26_out1;

  
  Switch6_out1_10 <= Constant3_out1_1 WHEN Relational_Operator_out1 = '0' ELSE
      Switch2_out1_12;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay4_PS_27_out1 <= Switch6_out1_10;
      END IF;
    END IF;
  ...
  Logical_Operator_out1_23 <= Compare_To_Zero_out1_1 OR BitSlice2_out1_2;
  ...
  switch1_out1_15 <= BitSlice3_out1 WHEN Logical_Operator_out1_23 = '0' ELSE
      C_out1_5;

  C1_out1 <= to_unsigned(16#400000#, 23);

  
  if_aSign_1_1_out1 <= Switch_out1 WHEN Delay2_PS_1_out1 = '0' ELSE
      C1_out1;
  ...
  Switch3_out1_1 <= switch1_out1_15 WHEN Delay9_PS_2_26_out1 = '0' ELSE
      Delay8_PS_2_26_out1;

  
  Switch5_out1_11 <= Constant2_out1_2 WHEN Relational_Operator_out1 = '0' ELSE
      Switch3_out1_1;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      ...
      ELSIF enb = '1' THEN
        Delay5_PS_27_out1 <= Switch5_out1_11;
      END IF;
    END IF;
