...
HD_PWD='D:/rit/private/mathworks/fileExchange/ravven-tag/frameBased/matlabWithSimulinkSingle/models/guassianFilterHardCoded/hdl_prj1/vivado_ip_prj/vivado_prj.runs/impl_1'
cd "$HD_PWD"
