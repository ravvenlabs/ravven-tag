-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_adapter_in_module.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_adapter_in_module
-- Source Path: gaussianF_ip/gaussianF_ip_axi4_stream_video_slave/gaussianF_ip_adapter_in/gaussianF_ip_adapter_in_module
-- Hierarchy Level: 3
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY gaussianF_ip_adapter_in_module IS
...
END gaussianF_ip_adapter_in_module;


ARCHITECTURE rtl OF gaussianF_ip_adapter_in_module IS
  ...
  SIGNAL data_buf_1                       : unsigned(63 DOWNTO 0);  -- ufix64
  ...
  SIGNAL vend_reg_1                       : std_logic_vector(1 DOWNTO 0);  -- ufix1 [2]
...
BEGIN
  ...
  data_buf_1 <= data_buf WHEN tvalid = '0' ELSE
      data_in_unsigned;
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        vend_reg_1 <= (OTHERS => '0');
      ELSIF enb = '1' THEN
        vend_reg_1(0) <= vend_reg;
        vend_reg_1(1) <= vend_reg_1(0);
      END IF;
    END IF;
