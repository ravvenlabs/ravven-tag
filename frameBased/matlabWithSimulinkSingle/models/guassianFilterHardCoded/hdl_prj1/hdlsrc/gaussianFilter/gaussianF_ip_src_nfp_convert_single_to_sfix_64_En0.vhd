-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_src_nfp_convert_single_to_sfix_64_En0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_src_nfp_convert_single_to_sfix_64_En0
-- Source Path: gaussianFilter/gaussianFilter/singleToUint32/nfp_convert_single_to_sfix_64_En0
-- Hierarchy Level: 2
-- Model version: 8.39
-- 
...
ENTITY gaussianF_ip_src_nfp_convert_single_to_sfix_64_En0 IS
...
END gaussianF_ip_src_nfp_convert_single_to_sfix_64_En0;


ARCHITECTURE rtl OF gaussianF_ip_src_nfp_convert_single_to_sfix_64_En0 IS
  ...
  SIGNAL Data_Type_Conversion_out1        : unsigned(87 DOWNTO 0);  -- ufix88_En24
  ...
  SIGNAL Shift_Arithmetic1_out1           : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL Compare_To_Zero1_out1_1          : std_logic;
  SIGNAL Compare_To_Zero_out1_1           : std_logic;
  SIGNAL Logical_Operator_out1            : std_logic;
  SIGNAL Delay3_out1_1                    : std_logic;
  SIGNAL Delay4_out1_1                    : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL Bit_Set_out1                     : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL Switch2_out1_1                   : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL shift_arithmetic2_zerosig        : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL shift_arithmetic2_selsig         : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Data_Type_Conversion1_out1_1     : unsigned(87 DOWNTO 0);  -- ufix88_En24
  ...
  SIGNAL Shift_Arithmetic2_out1           : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL Delay6_out1                      : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL Switch1_out1                     : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL Delay9_out1                      : unsigned(87 DOWNTO 0);  -- ufix88_En24
  SIGNAL Data_Type_Conversion1_out1_2     : signed(88 DOWNTO 0);  -- sfix89_En24
  SIGNAL Unary_Minus_cast                 : signed(89 DOWNTO 0);  -- sfix90_En24
  SIGNAL Unary_Minus_cast_1               : signed(89 DOWNTO 0);  -- sfix90_En24
  SIGNAL Unary_Minus_out1                 : signed(88 DOWNTO 0);  -- sfix89_En24
  SIGNAL Switch1_out1_1                   : signed(88 DOWNTO 0);  -- sfix89_En24
  SIGNAL Data_Type_Conversion2_out1       : signed(63 DOWNTO 0);  -- sfix64
  SIGNAL Delay8_out1                      : signed(63 DOWNTO 0);  -- sfix64
...
BEGIN
  ...
  Data_Type_Conversion_out1 <= resize(Delay2_out1 & '0', 88);
  ...
  Compare_To_Zero1_out1_1 <= '1' WHEN Shift_Arithmetic1_out1 = to_unsigned(0, 88) ELSE
      '0';

  
  Compare_To_Zero_out1_1 <= '1' WHEN Data_Type_Conversion_out1 /= to_unsigned(0, 88) ELSE
      '0';
  ...
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay4_out1_1 <= to_unsigned(0, 88);
      ELSIF enb = '1' THEN
  ...
  Bit_Set_out1 <= Delay4_out1_1 OR to_unsigned(1, 88);
  ...
  Data_Type_Conversion1_out1_1 <= resize(Delay2_out1 & '0', 88);
  ...
  Data_Type_Conversion1_out1_2 <= signed(resize(Delay9_out1, 89));

  Unary_Minus_cast <= resize(Data_Type_Conversion1_out1_2, 90);
  Unary_Minus_cast_1 <=  - (Unary_Minus_cast);
  Unary_Minus_out1 <= Unary_Minus_cast_1(88 DOWNTO 0);

  
  Switch1_out1_1 <= Data_Type_Conversion1_out1_2 WHEN Delay10_out1 = '0' ELSE
      Unary_Minus_out1;

  Data_Type_Conversion2_out1 <= Switch1_out1_1(87 DOWNTO 24);

  Delay8_process : PROCESS (clk)
  BEGIN
    IF clk'EVENT AND clk = '1' THEN
      IF reset = '1' THEN
        Delay8_out1 <= to_signed(0, 64);
      ELSIF enb = '1' THEN
