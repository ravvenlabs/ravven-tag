-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_src_nfp_convert_single_to_sfix_8_En0.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_src_nfp_convert_single_to_sfix_8_En0
-- Source Path: gaussianFilter/gaussianFilter/singleToUint32/nfp_convert_single_to_sfix_8_En0
-- Hierarchy Level: 2
-- Model version: 8.39
-- 
...
ENTITY gaussianF_ip_src_nfp_convert_single_to_sfix_8_En0 IS
...
END gaussianF_ip_src_nfp_convert_single_to_sfix_8_En0;


ARCHITECTURE rtl OF gaussianF_ip_src_nfp_convert_single_to_sfix_8_En0 IS
  ...
  SIGNAL Bit_Set_out1                     : unsigned(31 DOWNTO 0);  -- ufix32_En24
  SIGNAL Switch2_out1_1                   : unsigned(31 DOWNTO 0);  -- ufix32_En24
  ...
  SIGNAL Data_Type_Conversion2_out1       : signed(7 DOWNTO 0);  -- sfix8
  SIGNAL Delay8_out1                      : signed(7 DOWNTO 0);  -- sfix8
...
BEGIN
  ...
  Compare_To_Zero1_out1_1 <= '1' WHEN Shift_Arithmetic1_out1 = to_unsigned(0, 32) ELSE
      '0';

  
  Compare_To_Zero_out1_1 <= '1' WHEN Data_Type_Conversion_out1 /= to_unsigned(0, 32) ELSE
      '0';
  ...
  Bit_Set_out1 <= Delay4_out1_1 OR to_unsigned(1, 32);
  ...
  Data_Type_Conversion2_out1 <= Switch1_out1_1(31 DOWNTO 24);
