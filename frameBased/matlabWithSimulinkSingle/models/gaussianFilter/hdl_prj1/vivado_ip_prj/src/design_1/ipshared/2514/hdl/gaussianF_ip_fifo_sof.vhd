-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_fifo_sof.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_fifo_sof
-- Source Path: gaussianF_ip/gaussianF_ip_axi4_stream_video_slave/gaussianF_ip_fifo_sof
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY gaussianF_ip_fifo_sof IS
...
END gaussianF_ip_fifo_sof;


ARCHITECTURE rtl OF gaussianF_ip_fifo_sof IS
...
BEGIN
  ...
  u_gaussianF_ip_fifo_sof_classic_ram : gaussianF_ip_SimpleDualPortRAM_singlebit
