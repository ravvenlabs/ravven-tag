-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_axi_lite.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_axi_lite
-- Source Path: gaussianF_ip/gaussianF_ip_axi_lite
-- Hierarchy Level: 1
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY gaussianF_ip_axi_lite IS
...
END gaussianF_ip_axi_lite;


ARCHITECTURE rtl OF gaussianF_ip_axi_lite IS

  -- Component Declarations
  COMPONENT gaussianF_ip_addr_decoder
  ...
  COMPONENT gaussianF_ip_axi_lite_module
    PORT( clk                             :   IN    std_logic;  -- ufix1
          AXI4_Lite_ARESETN               :   IN    std_logic;  -- ufix1
          AXI4_Lite_AWADDR                :   IN    std_logic_vector(15 DOWNTO 0);  -- ufix16
          AXI4_Lite_AWVALID               :   IN    std_logic;  -- ufix1
  ...
  FOR ALL : gaussianF_ip_addr_decoder
    USE ENTITY work.gaussianF_ip_addr_decoder(rtl);

  FOR ALL : gaussianF_ip_axi_lite_module
    USE ENTITY work.gaussianF_ip_axi_lite_module(rtl);
...
BEGIN
  u_gaussianF_ip_addr_decoder_inst : gaussianF_ip_addr_decoder
  ...
  u_gaussianF_ip_axi_lite_module_inst : gaussianF_ip_axi_lite_module
    PORT MAP( clk => AXI4_Lite_ACLK,  -- ufix1
