-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_fifo_sof_out.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_fifo_sof_out
-- Source Path: gaussianF_ip/gaussianF_ip_axi4_stream_video_master/gaussianF_ip_fifo_sof_out
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY gaussianF_ip_fifo_sof_out IS
...
END gaussianF_ip_fifo_sof_out;


ARCHITECTURE rtl OF gaussianF_ip_fifo_sof_out IS

  -- Component Declarations
  COMPONENT gaussianF_ip_SimpleDualPortRAM_singlebit
  ...
  FOR ALL : gaussianF_ip_SimpleDualPortRAM_singlebit
    USE ENTITY work.gaussianF_ip_SimpleDualPortRAM_singlebit(rtl);
...
BEGIN
  ...
  u_gaussianF_ip_fifo_sof_out_classic_ram_singlebit : gaussianF_ip_SimpleDualPortRAM_singlebit
