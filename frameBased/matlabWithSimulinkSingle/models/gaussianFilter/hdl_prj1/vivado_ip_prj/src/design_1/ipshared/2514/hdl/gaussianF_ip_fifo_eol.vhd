-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj1\hdlsrc\gaussianFilter\gaussianF_ip_fifo_eol.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_fifo_eol
-- Source Path: gaussianF_ip/gaussianF_ip_axi4_stream_video_slave/gaussianF_ip_fifo_eol
-- Hierarchy Level: 2
-- 
-- -------------------------------------------------------------
LIBRARY IEEE;
...
ENTITY gaussianF_ip_fifo_eol IS
...
END gaussianF_ip_fifo_eol;


ARCHITECTURE rtl OF gaussianF_ip_fifo_eol IS
...
BEGIN
  ...
  u_gaussianF_ip_fifo_eol_classic_ram : gaussianF_ip_SimpleDualPortRAM_singlebit
