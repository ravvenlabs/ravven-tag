-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj3\hdlsrc\gaussianFilter\gaussianF_ip_src_nfp_convert_sfix_8_En0_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_src_nfp_convert_sfix_8_En0_to_single
-- Source Path: gaussianFilter/gaussianFilter/singleToUint32/nfp_convert_sfix_8_En0_to_single
-- Hierarchy Level: 2
-- Model version: 8.37
-- 
...
ENTITY gaussianF_ip_src_nfp_convert_sfix_8_En0_to_single IS
...
END gaussianF_ip_src_nfp_convert_sfix_8_En0_to_single;


ARCHITECTURE rtl OF gaussianF_ip_src_nfp_convert_sfix_8_En0_to_single IS

  -- Signals
  SIGNAL nfp_in_signed                    : signed(7 DOWNTO 0);  -- int8
  SIGNAL Delay_out1                       : signed(7 DOWNTO 0);  -- sfix8
  ...
  SIGNAL Delay_out1_dtc                   : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL Unary_Minus_in0                  : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Unary_Minus_out1                 : signed(7 DOWNTO 0);  -- sfix8
  SIGNAL Unary_Minus_out1_dtc             : unsigned(7 DOWNTO 0);  -- ufix8
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_signed(16#00#, 8) ELSE
      '0';
  ...
  Compare_To_Zero_out1 <= '1' WHEN Delay_out1 < to_signed(16#00#, 8) ELSE
      '0';
  ...
  Unary_Minus_in0 <=  - (resize(Delay_out1, 9));
  Unary_Minus_out1 <= Unary_Minus_in0(7 DOWNTO 0);
