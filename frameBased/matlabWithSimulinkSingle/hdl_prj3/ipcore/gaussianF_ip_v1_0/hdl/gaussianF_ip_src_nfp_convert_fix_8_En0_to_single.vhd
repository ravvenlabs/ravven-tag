-- -------------------------------------------------------------
-- 
-- File Name: hdl_prj3\hdlsrc\gaussianFilter\gaussianF_ip_src_nfp_convert_fix_8_En0_to_single.vhd
...
-- -------------------------------------------------------------
-- 
-- Module: gaussianF_ip_src_nfp_convert_fix_8_En0_to_single
-- Source Path: gaussianFilter/gaussianFilter/uint32Tosingle2/nfp_convert_fix_8_En0_to_single
-- Hierarchy Level: 2
-- Model version: 8.37
-- 
...
ENTITY gaussianF_ip_src_nfp_convert_fix_8_En0_to_single IS
...
END gaussianF_ip_src_nfp_convert_fix_8_En0_to_single;


ARCHITECTURE rtl OF gaussianF_ip_src_nfp_convert_fix_8_En0_to_single IS

  -- Signals
  SIGNAL nfp_in_unsigned                  : unsigned(7 DOWNTO 0);  -- uint8
  ...
  SIGNAL Data_Type_Conversion1_out1       : signed(7 DOWNTO 0);  -- sfix8
  SIGNAL Unary_Minus_cast                 : unsigned(7 DOWNTO 0);  -- ufix8
  SIGNAL Unary_Minus_cast_1               : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Unary_Minus_cast_2               : signed(8 DOWNTO 0);  -- sfix9
  SIGNAL Unary_Minus_out1                 : unsigned(7 DOWNTO 0);  -- ufix8
...
BEGIN
  ...
  CompareToZero1_out1 <= '1' WHEN Delay_out1 = to_unsigned(16#00#, 8) ELSE
      '0';
  ...
  Unary_Minus_cast_1 <= signed(resize(Unary_Minus_cast, 9));
  Unary_Minus_cast_2 <=  - (Unary_Minus_cast_1);
  Unary_Minus_out1 <= unsigned(Unary_Minus_cast_2(7 DOWNTO 0));
