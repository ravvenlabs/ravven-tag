...
for i = 1:1:4 
    ...
    if fpga == 1    
        if i == 1
            figure
            imagesc(dirMagNorthBW_mdl);
            BW = dirMagNorthBW_mdl;
            title('northBW'); 
        elseif i == 2
            figure
            imagesc(dirMagNorthWestBW_mdl);
            BW = dirMagNorthWestBW_mdl;
            title('northWestBW'); 
        elseif i == 3
            figure
            imagesc(dirMagWestBW_mdl);
            BW = dirMagWestBW_mdl;
            title('westBW'); 
        elseif i == 4
            figure
            imagesc(dirMagSouthWestBW_mdl);
            BW = dirMagSouthWestBW_mdl;
            title('southWestBW'); 
        end    
    end
